...
The button deploys your own instance of the backend to your own Cloudflare account: it clones the repository to your GitHub or GitLab account, prompts for the two Anthropic secrets, and deploys the Worker through Workers Builds. See [`backends/cloudflare/README.md`](backends/cloudflare/README.md) for what it provisions and the manual alternative.
